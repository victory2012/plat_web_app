export default {
  ...
  loginMsg: {
    ...
    errorMsg: {
      ...
      checkAccount: 'The length of the user name is 4~20',
      checkFormat: 'The user name is misformatted',
      checkPassWord: 'The password length is 6~20',
      checkPasswordFormat: 'Wrong password format'
    },
  ...
  useMsg: {
    ...
    warn: {
      ...
      password: 'Please enter password.',
      passwordLimit: 'Password length is 6 to 20 characters.',
